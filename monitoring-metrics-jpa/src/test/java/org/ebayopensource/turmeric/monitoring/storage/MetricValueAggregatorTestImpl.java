...
public class MetricValueAggregatorTestImpl implements MetricValueAggregator
{
    ...
    private MetricValueAggregatorTestImpl(MetricValue metricValue, MetricCategory category, MonitoringLevel level, Map<MetricClassifier, MetricValue> valuesByClassifier) {
    ...
    public MetricValue deepCopy(boolean isReadOnly) {
        ...
        MetricValueAggregatorTestImpl result = new MetricValueAggregatorTestImpl(metricValue, category, level, valuesByClassifierCopy);
    ...
    private MetricValue cloneMetricValue() {
        try {
            return this.metricValue.getClass().getConstructor(MetricId.class).newInstance(this.metricValue.getMetricId());
        } catch (Exception x) {
