 ...
 */
public class ServiceOperationByIpReader extends ColumnFamilyReader<String> {
    ...
    *           the connection info
    */
   public ServiceOperationByIpReader(Date startTime, Date endTime, CassandraConnectionInfo connectionInfo) {
