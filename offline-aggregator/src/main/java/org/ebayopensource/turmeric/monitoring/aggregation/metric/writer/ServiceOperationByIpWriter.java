 ...
 */
public class ServiceOperationByIpWriter extends CassandraObject implements CassandraDataWriter<String> {

   private static final String columnFamilyName = "ServiceOperationByIp";
    ...
    *           the connection info
    */
   public ServiceOperationByIpWriter(Date startTime, Date endTime, CassandraConnectionInfo connectionInfo) {
   ...
   public void writeData(Map<String, AggregationData<String>> data) {
      Mutator<String> mutator = HFactory.createMutator(connectionInfo.getKeyspace(),
               STR_SERIALIZER);
