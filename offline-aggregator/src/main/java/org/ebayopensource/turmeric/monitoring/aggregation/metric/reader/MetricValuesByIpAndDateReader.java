 ...
 */
public class MetricValuesByIpAndDateReader extends ColumnFamilyReader<String> {
    ...
    *           the connection info
    */
   public MetricValuesByIpAndDateReader(Date startTime, Date endTime, CassandraConnectionInfo connectionInfo) {
