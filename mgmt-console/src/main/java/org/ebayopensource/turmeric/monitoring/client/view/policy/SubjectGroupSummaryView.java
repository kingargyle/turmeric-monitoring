	...
	private class ContentView extends AbstractGenericView implements Display {
		...
		public void initialize() {
			...
			cellTable.addColumn(viewColumn,
					ConsoleUtil.policyAdminConstants.view());
			...
			cellTable.addColumn(groupNameCol,
					ConsoleUtil.policyAdminConstants.subjectGroupName());
			...
			cellTable.addColumn(descCol,
					ConsoleUtil.policyAdminConstants.description());
			...
			cellTable.addColumn(groupSubjectsCol,
					ConsoleUtil.policyAdminConstants.subjectsAssigned());
			...
			cellTable.addColumn(groupPoliciesCol,
					ConsoleUtil.policyAdminConstants.policiesAssigned());
