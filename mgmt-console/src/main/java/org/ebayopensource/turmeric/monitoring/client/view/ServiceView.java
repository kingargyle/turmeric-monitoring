...
public class ServiceView extends ResizeComposite implements ServicePresenter.Display {
	...
	public void setMetric (ServiceMetric metric, MetricData data) {
	    ...
	    String date2Header = "";
	    if (data != null) {
	        String d1 = ConsoleUtil.timeFormat.format(new Date(data.getMetricCriteria().date1));
	        String d2 = ConsoleUtil.timeFormat.format(new Date(data.getMetricCriteria().date2));
