...
public class FilterWidget extends Composite implements Filterable {
	...
	public void position() {
		...
		filterTable.getCellFormatter().setHorizontalAlignment(0, 0,
		...
		filterTable.getCellFormatter().setHorizontalAlignment(1, 0,
				HasHorizontalAlignment.ALIGN_LEFT);
		...
		filterTable.getCellFormatter().setHorizontalAlignment(2, 0,
				HasHorizontalAlignment.ALIGN_LEFT);
		...
		filterTable.getCellFormatter().setHorizontalAlignment(3, 0,
				HasHorizontalAlignment.ALIGN_LEFT);
		filterTable.getCellFormatter().setWordWrap(3, 0, false);
		filterTable.setWidget(3, 1, metricsGrid);
		filterTable.getCellFormatter().setVerticalAlignment(3, 0,
				HasVerticalAlignment.ALIGN_TOP);

		filterTable.setWidget(4, 0, advancedPanel);
		filterTable.getCellFormatter().setHorizontalAlignment(4, 0,
				HasHorizontalAlignment.ALIGN_LEFT);
	...
	public void setDurations(int[] durations) {
		...
		for (int i = 0; i < durations.length; i++) {
			durationInput.addItem(String.valueOf(durations[i])
	...
	public void setMetricNames(List<String> names) {
		...
		for (String name : names) {
			String localizedName = (String) ConsoleUtil.constants
					.metricNameMap().get(name);
