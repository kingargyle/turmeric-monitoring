...
public class SubjectGroupViewPresenter extends AbstractGenericPresenter {
    ...
    public SubjectGroupViewPresenter (HandlerManager eventBus, SubjectGroupViewDisplay view, Map<SupportedService, ConsoleService> serviceMap) {
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.monitoring.client.presenter.AbstractGenericPresenter#getView()
     */
    @Override
