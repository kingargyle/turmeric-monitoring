 ...
 *
 */
public class PolicyQueryServiceImpl extends AbstractConsoleService implements PolicyQueryService {
    private static final String BASE_POLICY_URL =  GWT.getModuleBaseURL()+"policy";
    ...
    public void createSubjectGroups(final List<SubjectGroup> groups,
        ...
        if (groups != null) {
            ...
            for (SubjectGroup g:groups) {
                url += (g.getName() == null? "": "&ns1:subjectGroups("+i+").@SubjectGroupName="+g.getName().trim());
                url += (g.getType() == null? "": "&ns1:subjectGroups("+i+").@SubjectType="+g.getType().toString());
                url += (g.getDescription() == null? "": "&ns1:subjectGroups("+i+").@Description="+g.getDescription());
                ...
                if (g.getSubjects() != null) {
                    ...
                    for (String s:g.getSubjects()) {
                        ...
                        url += "&ns1:subjectGroups("+i+").ns1:Subject("+j+").@SubjectType="+g.getType().toString();
                        j++;
                    }
                }
                i++;
                ...
                builder.sendRequest(null, new RequestCallback() {
                    ...
                    public void onResponseReceived(Request request, Response response) {
                        if (response.getStatusCode() != Response.SC_OK) {
                            ...
                            CreateSubjectGroupsResponse createResponse = CreateSubjectGroupsResponseJS.fromJSON(response.getText());
    ...
    /**
     * @see org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService#deletePolicy(org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService.DeletePolicyRequest, com.google.gwt.user.client.rpc.AsyncCallback)
     */
    @Override
    public void deletePolicy(final PolicyKey key,
        ...
        url += (key.getType() == null? "": "&ns1:policyKey.ns1:policyType="+key.getType().toString().toUpperCase());
            ...
            builder.sendRequest(null, new RequestCallback() {
                ...
                public void onResponseReceived(Request request, Response response) {
                    if (response.getStatusCode() != Response.SC_OK) {
                        ...
                        //convert response.getText() to JSON
                        DeletePolicyResponse deleteResponse = DeletePolicyResponseJS.fromJSON(response.getText());
    ...
    /**
     * @see org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService#deleteResource(org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService.DeleteResourceRequest, com.google.gwt.user.client.rpc.AsyncCallback)
     */
    @Override
    public void deleteResources(List<ResourceKey> keys, AsyncCallback<DeleteResourceResponse> callback) {
        // TODO Auto-generated method stub

    }

    /**
     * @see org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService#deleteSubjectGroup(org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService.DeleteSubjectGroupRequest, com.google.gwt.user.client.rpc.AsyncCallback)
     */
    @Override
    public void deleteSubjectGroups(final List<SubjectGroupKey> keys,
        ...
        for (SubjectGroupKey key:keys) {
            url += (key.getId() == null? "": "&ns1:subjectGroupKey("+i+").ns1:subjectGroupId="+key.getId().toString());
            url += (key.getName() == null? "": "&ns1:subjectGroupKey("+i+").ns1:subjectGroupName="+key.getName().trim());
            url += (key.getType() == null? "": "&ns1:subjectGroupKey("+i+").ns1:subjectType="+key.getType().toString());
            i++;
        }
        RequestBuilder builder = new RequestBuilder(RequestBuilder.GET, URL.encode(url));
        setSecurityHeaders(builder);
            ...
            builder.sendRequest(null, new RequestCallback() {
                ...
                public void onResponseReceived(Request request, Response response) {
                    if (response.getStatusCode() != Response.SC_OK) {
                        ...
                        //convert response.getText() to JSON
                        DeleteSubjectGroupResponse delResponse = DeleteSubjectGroupResponseJS.fromJSON(response.getText());
    ...
    /**
     * @see org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService#disablePolicy(org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService.DisablePolicyRequest, com.google.gwt.user.client.rpc.AsyncCallback)
     */
    @Override
            ...
            builder.sendRequest(null, new RequestCallback() {
                ...
                public void onResponseReceived(Request request, Response response) {
                    ...
                    if (response.getStatusCode() != Response.SC_OK) {
                        ...
                        //convert response.getText() to JSON
                        DisablePolicyResponse enableResponse = DisablePolicyResponseJS.fromJSON(response.getText());
    ...
    /**
     * @see org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService#enablePolicy(org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService.EnablePolicyRequest, com.google.gwt.user.client.rpc.AsyncCallback)
     */
    @Override
            ...
            builder.sendRequest(null, new RequestCallback() {
                ...
                public void onResponseReceived(Request request, Response response) {
                    if (response.getStatusCode() != Response.SC_OK) {
                        ...
                        //convert response.getText() to JSON
                        EnablePolicyResponse enableResponse = EnablePolicyResponseJS.fromJSON(response.getText());
                        if (enableResponse.isErrored())
                            callback.onFailure(getErrorAsThrowable(EnablePolicyResponseJS.NAME, response));
                        else
                            callback.onSuccess(enableResponse);
    ...
    /**
     * @see org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService#getResources(org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService.GetResourcesRequest, com.google.gwt.user.client.rpc.AsyncCallback)
     */
    @Override
    public void getResources(final List<ResourceKey> keys, final AsyncCallback<GetResourcesResponse> callback) {
        ...
        for (ResourceKey key:keys) {
            url += (key.getId() == null? "": "&ns1:resourceKey("+i+").ns1:resourceId="+key.getId().toString());
            url += (key.getName() == null || key.getName().trim().isEmpty()? "": "&ns1:resourceKey("+i+").ns1:resourceName=" + key.getName().trim());
            url += (key.getType() == null || key.getType().trim().isEmpty() ? "": "&ns1:resourceKey("+i+").ns1:resourceType=" + key.getType().toString().toUpperCase());
            i++;
        }
            ...
            builder.sendRequest(null, new RequestCallback() {
                ...
                public void onResponseReceived(Request request, Response response) {
                    if (response.getStatusCode() != Response.SC_OK) {
                        ...
                        //convert response.getText() to JSON
                        GetResourcesResponse resourcesResponse = GetResourcesResponseJS.fromJSON(response.getText());
    ...
    /**
     * @see org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService#getPoliciesByKey(org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyKey, com.google.gwt.user.client.rpc.AsyncCallback)
     */
    @Override
    public void findPolicies (Long sinceLastModifiedTime,
        ...
        //sinceLastModifiedTime is measured as the milliseconds since the epoch(GMT)
        // "YYYY-MM-DDThh:mm:ssZ"  eg  2002-05-30T09:30:10Z
        if (sinceLastModifiedTime != null) {
            String time = ConsoleUtil.xsDateTimeFormat.format(new Date(sinceLastModifiedTime.longValue()));
...
//        }
        ...
        if (condition != null) {
            url += (condition.getResolution()==null? "": "&ns1:queryCondition.ns1:resolution="+condition.getResolution().toString());
    ...
    /**
     * @see org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService#getEntityHistory(org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService.GetEntityHistoryRequest, com.google.gwt.user.client.rpc.AsyncCallback)
     */
    @Override
   public void getEntityHistory(Long startDate, Long endDate,
    	...
    	if (startDate == null || endDate == null || startDate>endDate)
          ...
          // "YYYY-MM-DDThh:mm:ssZ"  eg  2002-05-30T09:30:10Z
          String start = ConsoleUtil.xsDateTimeFormat.format(new Date(startDate.longValue())).trim();
          url += "&ns1:startDate="+URL.encodeQueryString(start);
          
          String end = ConsoleUtil.xsDateTimeFormat.format(new Date(endDate.longValue())).trim();
              ...
              builder.sendRequest(null, new RequestCallback() {
                  ...
                  public void onResponseReceived(Request request, Response response) {
                	  if (response.getStatusCode() != Response.SC_OK) {
                          ...
                          //convert response.getText() to JSON
                          GetEntityHistoryResponse createResponse = GetEntityHistoryResponseJS.fromJSON(response.getText());
                          if (createResponse.isErrored()) {
                              callback.onFailure(getErrorAsThrowable(GetEntityHistoryResponseJS.NAME, response));
                          } else
                              callback.onSuccess(createResponse);
    ...
    public void findSubjectGroups(final SubjectGroupQuery query,
        ...
        if (query.getGroupKeys() != null) {
            ...
            for (SubjectGroupKey key:query.getGroupKeys()) {
                url += (key.getType()==null || "".equals(key.getType().trim())?"":"&ns1:subjectGroupQuery.ns1:subjectGroupKey("+i+").ns1:subjectType="+key.getType());	
                url += ((key.getName() ==null || key.getName().trim().isEmpty()) ? "" : "&ns1:subjectGroupQuery.ns1:subjectGroupKey("+i+").ns1:subjectGroupName=" + key.getName().trim());
                url += (key.getId()==null?"":"&ns1:subjectGroupQuery.ns1:subjectGroupKey("+i+").ns1:subjectGroupId="+key.getId().toString());
                i++;
            }
        }
            ...
            builder.sendRequest(null, new RequestCallback() {
                ...
                public void onResponseReceived(Request request, Response response) {
                    if (response.getStatusCode() != Response.SC_OK) {
                        ...
                        //convert response.getText() to JSON
                        FindSubjectGroupsResponse findResponse = FindSubjectGroupsResponseJS.fromJSON(response.getText());
                        if (findResponse.isErrored()) {
                            callback.onFailure(getErrorAsThrowable(FindSubjectGroupsResponseJS.NAME, response));
                        } else
                            callback.onSuccess(findResponse);
    ...
    /**
     * @see org.ebayopensource.turmeric.monitoring.client.model.policy.PolicyQueryService#updateSubjectGroups(java.util.List, com.google.gwt.user.client.rpc.AsyncCallback)
     */
    @Override
    public void updateSubjectGroups(List<SubjectGroup> groups,
                                    UpdateMode mode,
           ...
           for (SubjectGroup g:groups) {
               ...
               if (g.getSubjectMatchTypes() != null && g.getSubjectMatchTypes().size() > 0) {
                   ...
                   for (SubjectMatchType sm:g.getSubjectMatchTypes()) {
                       url += "&ns1:subjectGroups("+i+").ns2:SubjectMatch("+j+").@MatchId="+sm.getMatchId();
                       url += "&ns1:subjectGroups("+i+").ns2:SubjectMatch("+j+").ns2:AttributeValue="+sm.getAttributeValue();
                       url += "&ns1:subjectGroups("+i+").ns2:SubjectMatch("+j+").ns2:SubjectAttributeDesignator.@AttributeId="+sm.getSubjectAttributeDesignator();
                       j++;
                   }
               }
               ...
               builder.sendRequest(null, new RequestCallback() {
                   ...
                   public void onResponseReceived(Request request, Response response) {
                       if (response.getStatusCode() != Response.SC_OK) {
                           ...
                           //convert response.getText() to JSON
                           UpdateSubjectGroupsResponse updateResponse = UpdateSubjectGroupsResponseJS.fromJSON(response.getText());
                           if (updateResponse.isErrored())
                               callback.onFailure(getErrorAsThrowable(UpdateSubjectGroupsResponseJS.NAME, response));
                           else
    ...
    public void updatePolicy(UpdateMode mode, GenericPolicy policy,
        ...
        String url = BASE_POLICY_URL + "?"+getPartialUrl("updatePolicy", namespaces, RequestFormat.NV);
    ...
    private String createSubjectGroupKeyRequest(List<SubjectGroupKey> subjectGroupKeys, String url) {
        ...
        if (subjectGroupKeys != null && subjectGroupKeys.size() > 0) {
            ...
            for (SubjectGroupKey subjectGroupKey:subjectGroupKeys) {
                url += (subjectGroupKey.getType() == null || "".equals(subjectGroupKey.getType().trim())? "":"&ns1:subjectGroupKey("+i+").ns1:subjectType="+subjectGroupKey.getType());
                url += (subjectGroupKey.getId()==null ? "" : "&ns1:subjectGroupKey("+i+").ns1:subjectGroupId="+subjectGroupKey.getId());
                url += ((subjectGroupKey.getName()== null || subjectGroupKey.getName().trim().isEmpty())  ?"": "&ns1:subjectGroupKey("+i+").ns1:subjectGroupName=" + subjectGroupKey.getName().trim());	
                i++;
            }
        }
        return url;
	...
	private String createSubjectKeyRequest(List<SubjectKey> subjectKeys,
        ...
        if (subjectKeys != null && subjectKeys.size() > 0) {
            ...
            for (SubjectKey subjectKey:subjectKeys) {
            	url += (subjectKey.getType() == null || "".equals(subjectKey.getType().trim())? "":"&ns1:subjectKey("+i+").ns1:subjectType="+subjectKey.getType());
                url += (subjectKey.getId() == null? "":"&ns1:subjectKey("+i+").ns1:subjectId="+subjectKey.getId());
                url += ((subjectKey.getName()== null || subjectKey.getName().trim().isEmpty())  ?"": "&ns1:subjectKey("+i+").ns1:subjectName=" + subjectKey.getName().trim());	
	...
	private String createOperationKeyRequest(List<OperationKey> opKeys,
        ...
        if (opKeys != null && opKeys.size() > 0) {
            ...
            for (OperationKey opKey:opKeys) {
                ...
                url += (opKey.getOperationName() == null || opKey.getOperationName().trim().isEmpty()) ? "": "&ns1:operationKey("+i+").ns1:operationName=" + opKey.getOperationName().trim();
                url += (opKey.getResourceName() == null || opKey.getResourceName().trim().isEmpty())? "":"&ns1:operationKey("+i+").ns1:resourceName=" + opKey.getResourceName().trim();
                url += (opKey.getResourceType() == null || opKey.getResourceType().trim().isEmpty())? "": "&ns1:operationKey("+i+").ns1:resourceType=" + opKey.getResourceType();
                i++;
            }
        }
		return url;
	...
	private String createResourceKeyRequest(List<ResourceKey> resKeys,
        ...
        if (resKeys != null && resKeys.size() > 0) {
            ...
            for (ResourceKey resKey:resKeys) {
                url += (resKey.getId() == null? "":"&ns1:resourceKey("+i+").ns1:resourceId="+resKey.getId());
                url += (resKey.getType()  == null || resKey.getType().trim().isEmpty())? "": "&ns1:resourceKey("+i+").ns1:resourceType=" + resKey.getType();
                url += (resKey.getName() == null || resKey.getName().trim().isEmpty())? "": "&ns1:resourceKey("+i+").ns1:resourceName=" + resKey.getName().trim();
                i++;
            }
        }
		return url;
	...
	private String createPolicyKeyRequest(List<PolicyKey> keys, String url) {
        ...
        if (keys != null && keys.size() > 0) {
            ...
            for (PolicyKey key: keys) {
            	url += (key.getType() == null || "".equals(key.getType().trim())? "":"&ns1:policyKey("+i+").ns1:policyType="+key.getType());
                url += ((key.getId()== null)  ? "" : "&ns1:policyKey("+i+").ns1:policyId="+key.getId());
                url += ((key.getName()== null || key.getName().trim().isEmpty())  ?"": "&ns1:policyKey("+i+").ns1:policyName=" + key.getName().trim());	
