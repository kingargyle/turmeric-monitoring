...
public abstract class BaseTest {
	...
	public void setUp() throws Exception {
        ...
        metricsErrorValuesDAO = new MetricsErrorValuesDAOImpl(TURMERIC_TEST_CLUSTER, HOST, KEY_SPACE,
	...
	protected Collection<MetricValueAggregator> createMetricValueAggregatorsCollectionForOneConsumer(
