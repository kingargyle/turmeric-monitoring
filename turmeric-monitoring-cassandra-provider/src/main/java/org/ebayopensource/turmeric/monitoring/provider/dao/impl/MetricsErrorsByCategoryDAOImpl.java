 ...
 * @author jamuguerza
 */
public class MetricsErrorsByCategoryDAOImpl<K> extends BaseMetricsErrorsByFiltersDAOImpl<K> {
    ...
    */
   public MetricsErrorsByCategoryDAOImpl(final String clusterName, final String host, final String s_keyspace,
