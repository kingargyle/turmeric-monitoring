 ...
 * @author jamuguerza
 */
public class MetricServiceCallsByTimeDAOImpl<SK, K> extends AbstractSuperColumnFamilyDao<SK, SuperModel, K, BasicModel> {
    ...
    *           the k type class
    */
   public MetricServiceCallsByTimeDAOImpl(final String clusterName, final String host, final String s_keyspace,
            final String columnFamilyName, final Class<SK> sKTypeClass, final Class<K> kTypeClass) {
      super(clusterName, host, s_keyspace, sKTypeClass, SuperModel.class, kTypeClass, BasicModel.class,
               columnFamilyName);
   }
