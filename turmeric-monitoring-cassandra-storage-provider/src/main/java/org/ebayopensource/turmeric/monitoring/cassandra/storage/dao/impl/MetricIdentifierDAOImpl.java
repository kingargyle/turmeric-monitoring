 ...
 * @author jamuguerza
 */
public class MetricIdentifierDAOImpl<K> extends AbstractColumnFamilyDao<K, MetricIdentifier> {
    ...
    *           the k type class
    */
   public MetricIdentifierDAOImpl(String clusterName, String host, String s_keyspace, String columnFamilyName,
            final Class<K> kTypeClass) {
      super(clusterName, host, s_keyspace, kTypeClass, MetricIdentifier.class, columnFamilyName);
