 ...
 * @author jamuguerza
 */
public class MetricValuesByIpAndDateDAOImpl<SK, K> extends AbstractSuperColumnFamilyDao<SK, SuperModel, K, BasicModel> {
    ...
    *           the k type class
    */
   public MetricValuesByIpAndDateDAOImpl(final String clusterName, final String host, final String s_keyspace,
