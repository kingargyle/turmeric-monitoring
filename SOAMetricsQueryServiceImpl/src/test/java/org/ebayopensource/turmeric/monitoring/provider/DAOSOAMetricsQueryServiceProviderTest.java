...
public class DAOSOAMetricsQueryServiceProviderTest {
    ...
    public static void createData() throws Exception {
        ...
        try {
            ...
            try {
                ...
                MetricDef opTimeTotal = new MetricDef(SystemMetricDefs.OP_TIME_TOTAL.getMetricName(), MetricCategory.TIMING, MonitoringLevel.NORMAL);
                ...
                MetricDef opErrTotal = new MetricDef(SystemMetricDefs.OP_ERR_TOTAL.getMetricName(), MetricCategory.ERROR, MonitoringLevel.NORMAL);
                ...
                MetricDef opErrRequest = new MetricDef(SystemMetricDefs.OP_ERR_CAT_REQUEST.getMetricName(), MetricCategory.ERROR, MonitoringLevel.NORMAL);
                ...
                long oneMinuteAgo = now - TimeUnit.SECONDS.toMillis(60);
    ...
    public void testGetMetricValueByOperationAllServicesAllOperationsAllConsumers() {
        ...
        List<MetricGraphData> result = provider.getMetricValue(criteriaInfo, twoHoursAgo, duration, aggregationPeriod, null);
    ...
    public void testGetMetricValueByOperationOneServiceOneOperationAllConsumers() {
        ...
        long duration = 3600;
        int aggregationPeriod = 60;
        List<MetricGraphData> result = provider.getMetricValue(criteriaInfo, oneHourAgo, duration, aggregationPeriod, null);
        assertEquals(duration / aggregationPeriod, result.size());
    ...
    public void testGetMetricsMetadataByService() {
        List<String> serviceNames = provider.getMetricsMetadata(ResourceEntity.SERVICE.value(), Collections.<String>emptyList(), ResourceEntity.SERVICE.value());
        ...
        serviceNames = provider.getMetricsMetadata(ResourceEntity.SERVICE.value(), Arrays.asList("service_2"), ResourceEntity.SERVICE.value());
    ...
    public void testGetMetricsMetadataByOperation() {
        List<String> operationNames = provider.getMetricsMetadata(ResourceEntity.SERVICE.value(), Arrays.asList("service_1", "service_2"), ResourceEntity.OPERATION.value());
        ...
        operationNames = provider.getMetricsMetadata(ResourceEntity.SERVICE.value(), Arrays.asList("service_2"), ResourceEntity.OPERATION.value());
    ...
    public void testGetErrorMetricsDataByCategory() {
        ...
        errorData = provider.getErrorMetricsData("Category", Arrays.asList("service_3"), Arrays.asList("operation_3_1"), Arrays.asList("consumer_3"), errorId, ErrorCategory.SYSTEM.value(), ErrorSeverity.ERROR.value(), null, metricCriteria);
        assertEquals(1, errorData.size());
    ...
    public void testGetErrorMetricsDataBySeverity() {
        ...
        List<ErrorViewData> errorData = provider.getErrorMetricsData("Severity", Collections.<String>emptyList(), Collections.<String>emptyList(), Collections.<String>emptyList(), null, null, null, null, metricCriteria);
        assertEquals(1, errorData.size());
        ErrorViewData errorDatum = errorData.get(0);
        String errorId = "1";
        assertEquals(errorId, errorDatum.getError().getErrorId());
        ...
        assertEquals(1, errorDatum.getErrorCount1());
        assertEquals(0, errorDatum.getErrorCount2());
        assertEquals(-100, errorDatum.getErrorDiff(), 1);

        errorData = provider.getErrorMetricsData("Severity", Arrays.asList("service_3"), Arrays.asList("operation_3_1"), Arrays.asList("consumer_3"), errorId, ErrorCategory.SYSTEM.value(), ErrorSeverity.ERROR.value(), null, metricCriteria);
        assertEquals(1, errorData.size());
        errorDatum = errorData.get(0);
        assertEquals(errorId, errorDatum.getError().getErrorId());
        assertEquals(errorName, errorDatum.getError().getErrorName());
