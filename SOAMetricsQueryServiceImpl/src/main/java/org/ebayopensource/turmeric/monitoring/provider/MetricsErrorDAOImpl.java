...
/**
 * Extends the existing runtime ErrorDAOImpl with additional metrics methods.
 *  
 * @author sbordet
 *
 */
public class MetricsErrorDAOImpl extends ErrorDAOImpl implements
		MetricsErrorDAO {
	/**
	 * {@inheritDoc}
	 */
	...
	public List<Map<String, Object>> findErrorValuesByCategory(long beginTime,
		...
		return findErrorValues("Category", beginTime, endTime, serverSide,
				aggregationPeriod, errorId, category, severity, filters);
	}
	...
	public List<Map<String, Object>> findErrorValuesBySeverity(long beginTime,
			...
			Long errorId, String category, String severity,
			Map<String, List<String>> filters) {
		return findErrorValues("Severity", beginTime, endTime, serverSide,
				aggregationPeriod, errorId, category, severity, filters);
	}

	private List<Map<String, Object>> findErrorValues(String groupBy,
    ...
    @Override
    public List<Map<String, Object>>  findAllErrorValuesByCategory(long beginTime, long endTime, boolean serverSide,
                    int aggregationPeriod, Long errorId, String category, String severity,
                    Map<String, List<String>> filters) {
        List<String> serviceAdminNames = filters.get("Service");
        List<String> operationNames = filters.get("Operation");
        List<String> consumerNames = filters.get("Consumer");
        ...
        jpql.append(" order by ev.timeStamp ASC");
